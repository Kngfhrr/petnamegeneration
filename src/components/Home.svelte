  ...
  <div class="hero-body p-6 with-opacity">
    ...
    <div class="container">
      ...
      <div class="wrap-input-generation">
        ...
        <button on:click={getName} style={{ zIndex: 0 }} class="button is-info is-large"
          >{currentText.submitButton}</button
        >
      </div>
      <div class="mt-3">
        <h2 class="has-text-light transition-text">{currentText.subtitle}</h2>
